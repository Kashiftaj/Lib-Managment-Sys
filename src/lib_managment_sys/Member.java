...
public class Member extends javax.swing.JFrame {
    ...
    public Member() {
     ...
     public void load_member(){
        ...
        try {
            ...
            DefaultTableModel d=(DefaultTableModel) membertbl.getModel();
            d.setRowCount(0);
    ...
    public void load_search(String str){
        ...
        try {
            pst=con.prepareStatement("select * from member where first_name like ?");
             pst.setString(1, "%" + str + "%");
            rs=pst.executeQuery();
    ...
    private void initComponents() {
        ...
        catlbl.setText("Member");
        jPanel1.add(catlbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 60, 200, 56));
        ...
        jPanel1.add(statuslbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 300, 60, 36));
        ...
        jPanel1.add(catnamelbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 200, 100, 30));
        ...
        membertbl.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "First Name", "Last Name", "Phone", "Status"
            }
        ));
        membertbl.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusLost(java.awt.event.FocusEvent evt) {
                membertblFocusLost(evt);
            }
        });
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 120, 470, 350));
        ...
        jPanel1.add(addbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 380, 120, 30));
        ...
        jPanel1.add(deletebtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 430, 120, 30));
        ...
        jPanel1.add(updatebtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 380, 110, 30));
        ...
        jPanel1.add(checkbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 80, 90, 30));
        ...
        jPanel1.add(catnamelbl1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 146, 110, 30));

        lnametf.setFont(new java.awt.Font("Lucida Fax", 1, 16)); // NOI18N
        lnametf.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 255, 255), 2, true));
        jPanel1.add(lnametf, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 200, 160, 29));

        fnametf.setFont(new java.awt.Font("Lucida Fax", 1, 16)); // NOI18N
        fnametf.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 255, 255), 2, true));
        jPanel1.add(fnametf, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 150, 160, 29));

        statuslbl1.setBackground(new java.awt.Color(0, 0, 0));
        statuslbl1.setFont(new java.awt.Font("Lucida Fax", 1, 16)); // NOI18N
        statuslbl1.setForeground(new java.awt.Color(255, 255, 255));
        statuslbl1.setText("Phone");
        jPanel1.add(statuslbl1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 256, 80, 30));

        phonetf.setFont(new java.awt.Font("Lucida Fax", 1, 16)); // NOI18N
        phonetf.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 255, 255), 2, true));
        jPanel1.add(phonetf, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 260, 160, 30));

        scombo.setFont(new java.awt.Font("Lucida Fax", 1, 16)); // NOI18N
        scombo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Active", "Inactive" }));
        scombo.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(255, 255, 255), 2, true));
        jPanel1.add(scombo, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 310, 160, -1));
        ...
        jPanel1.add(searchtf, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 82, 150, 30));

        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("Search below");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 40, 120, 30));
    ...
    private void deletebtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deletebtnActionPerformed
        DefaultTableModel d1=(DefaultTableModel) membertbl.getModel();
       ...
       int id=Integer.parseInt( d1.getValueAt(index, 0).toString());
         ...
         try {
            ...
            int k =pst.executeUpdate();
              ...
              if(k==1){
       JOptionPane.showMessageDialog(rootPane, "member deleted succesfuly");
       
       phonetf.setText("");
       fnametf.setText("");
       lnametf.setText("");
       scombo.setSelectedItem(-1);
    ...
    private void addbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addbtnActionPerformed
        ...
        String scomb= scombo.getSelectedItem().toString();
       
        
         try {
            pst=con.prepareStatement("insert into member(first_name,last_name,contact,status)values(?,?,?,?) ");
       
            pst.setString(1, fname);
            pst.setString(2, lname);
            pst.setString(3, phone);
            pst.setString(4, scomb);
            
            int k =pst.executeUpdate();
             
              if(k==1){
       JOptionPane.showMessageDialog(rootPane, "Member added succesfuly");
    ...
    private void membertblMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_membertblMouseClicked
             ...
             scombo.setSelectedItem(d1.getValueAt(index, 4).toString());
    ...
    private void updatebtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updatebtnActionPerformed
       ...
       int id=Integer.parseInt( d1.getValueAt(index, 0).toString());
        ...
        String scomb= scombo.getSelectedItem().toString();
         ...
         try {
            pst=con.prepareStatement("update member set first_name= ?, last_name = ?,contact= ?,status = ? where mid= ? ");
            ...
            int k =pst.executeUpdate();
              ...
              if(k==1){
       JOptionPane.showMessageDialog(rootPane, "Member updated succesfuly");
    ...
    private void membertblFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_membertblFocusLost
        addbtn.setEnabled(true);
    }//GEN-LAST:event_membertblFocusLost
